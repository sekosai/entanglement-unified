...
def main() -> None:
    ...
    log("  by the particle's charge under the Higgs field. In the substrate")
    ...
    log("")
    log("  In the substrate framework, the Hadamard gate collapses the")
    log("  entanglement state to a definite bin. The bin size determines")
    log("  the charge quantum.")
    log("")
