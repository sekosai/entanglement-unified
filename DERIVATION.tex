...
The sensitivity confirms that small deviations from $a = 2$ produce
noticeably worse agreement with $G$. But the more important
question --- the one this paper's claim hinges on --- is whether
$a = 2$ is \emph{forced} by physics or merely \emph{found} to fit.
