...
|----------|-------------|
| [ANSATZ.pdf](ANSATZ.pdf) | Entanglement-ansatz for the Mach–Sciama relation, with predicted prefactor 4/5. Includes a Circularity & Scope section, the Earth-as-patch local test, and a "Toward a Local Derivation" section. |
...
| `verify_symbolic.py` | Symbolic (`sympy`) proof of the `<1/r>` integrals, the discrete `4/5` vs `16/15` prefactors, and the Step A–F algebra |
